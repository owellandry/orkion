...
export class SystemMcpClientAdapter implements McpClientLike {
  ...
  private async ensureConnected(): Promise<void> {
    ...
    const serverPath = fileURLToPath(new URL("./run-system-mcp-server.ts", import.meta.url));
    this.client = new Client({
      name: "orkion-system-client",
      version: "1.0.0"
    });
